...
<?php include_once("../managerNav.php");?>
        ...
        <div class="col-16 content">
            ...
            <div style="overflow-x:auto;">
                ...
                $sql="SELECT * FROM appointments WHERE state ='missed' ORDER BY date";
                $results = $conn->query($sql);
                    if(mysqli_num_rows($results)>0){

                ?>
                    
                    <h1 style="text-align:center;">CUSTOMER MISSED APPOINTMENTS</h1> <br><br>
                   ...
                   <!--table properties-->
                    ...
                    ?>
                        ...
                        echo "<h4>NO MISSED APPOINTMENTS CURRENTLY</h4>";
                    }
