        ...
        <div class="col-16 content">
            ...
            <div class="col-12 ProfileContainer">
                ...
                <div class="row r3-1">
                    ...
                    <form action="./viewService.php" method="GET">
                    ...
                    <div class="th-add-new-button">
                        <button class="navButton" onclick="document.location='./viewService.php'"  style="margin-top:30px;"><b> REFRESH</b></button><!--Here onclick is an event handler(in JS) it occurs when someone click an element for example form buttons,check box,etc.-->
                    </div>
