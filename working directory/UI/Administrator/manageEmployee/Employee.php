                ...
                if ( $result != false && $result->num_rows > 0) {
                    ...
                    ?>
                        <tr>
                            ...
                            <td><button class="th-button-icon"  data-val="<?php echo $row['id']  ?>" data-target="modal-2" onclick="openUpdateEmployee(this)" ><img src='../../../images/Employee & Supplier/edit.svg' class='th-svg-icons'></button></td>
                            <td><button class="th-button-icon"  data-val="<?php echo $row['id']  ?>" data-target="modal-3" onclick="openDeleteEmployee(this)" ></a><img src='../../../images/Employee & Supplier/delete.svg' class='th-svg-icons'></button></td>
                        </tr> 
