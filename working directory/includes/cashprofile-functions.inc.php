...
function updateProfile($conn, $fname, $lname, $contact, $address){
    ...
    if ($result) {
        header("location: ../UI/Cashier/cashierProfile/cashierViewProfile1.php?error=ProfileupdateSucess");
        exit();
    }
}
...
function emailNICTaken($conn, $email , $nic) {
    ...
    if(!mysqli_stmt_prepare($stmt, $sql)){
        header("location: ../UI/Cashier/cashierProfile/cashierChangeNIC.php?error=stmtfailed");
        exit();
    }
...
function updateNIC($conn, $nic, $password){
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            if ($checkPwd === false) {
                header("location: ../UI/Cashier/cashierProfile/cashierChangeNIC.php?error=incorrectpassword");
                exit();
            }
            ...
            elseif ($checkPwd === true) {
                ...
                if ($result) {
                    header("location: ../UI/Cashier/cashierProfile/cashierViewProfile1.php?error=NICupdateSucess");
                    exit();
                }
            }
        }
...
function updateEMAIL($conn, $email, $password){
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            if ($checkPwd === false) {
                header("location: ../UI/Cashier/cashierProfile/cashierChangeEmail.php?error=incorrectpassword");
                exit();
            }
            ...
            elseif ($checkPwd === true) {
                ...
                if ($result) {
                    header("location: ../UI/Cashier/cashierProfile/cashierViewProfile1.php?error=EmailupdateSucess");
                    exit();
                }
            }
        }
...
function updatePASSWORD($conn, $oldpassword, $newpassword, $confirmpwd){
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            if ($checkPwd === false) {
                header("location: ../UI/Cashier/cashierProfile/cashierChangePassword.php?error=incorrectpassword");
                exit();
            }
            ...
            elseif ($checkPwd === true) {
                ...
                if ($result) {
                    header("location: ../UI/Cashier/cashierProfile/cashierViewProfile1.php?error=passwordupdateSuccess");
                    exit();
                }
            }
        }
