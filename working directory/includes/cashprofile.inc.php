...
if (isset($_POST["profile-submit"])){
    ...
    require_once 'cashprofile-functions.inc.php';
...
if (isset($_POST["nic-submit"])){
    ...
    if (emailNICTaken($conn, $email, $nic) !== false){
        header("location: ../UI/Cashier/cashierProfile/cashierChangeNIC.php?error=email-nic-exists");
        exit();
    }
...
if (isset($_POST["email-submit"])){
    ...
    if (emailNICTaken($conn, $email, $nic) !== false){
        header("location: ../UI/Cashier/cashierProfile/cashierChangeEmail.php?error=email-nic-exists");
        exit();
    }
    if (invalidEmail($email) !== false){
        header("location: ../UI/Cashier/cashierProfile/cashierChangeEmail.php?error=invalidEmail");
        exit();
    }
...
if (isset($_POST["password-submit"])){
    ...
    if (pwdMatch($newpassword, $confirmpwd) !== false){
        header("location: ../UI/Cashier/cashierProfile/cashierChangePassword.php?error=passwordsdontmatch");
        exit();
    }
